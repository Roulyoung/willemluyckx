    ...
    >
      ...
      <main>
        {section === "blog" && slug ? (
          ...
          <PageView locale={locale} section={section} content={content} />
        )}
      </main>
...
const PageView = ({ locale, section, content }: { locale: Locale; section: string; content: LocaleContent }) => {
  ...
  return (
    <>
      <section className="mx-auto grid max-w-7xl gap-10 px-5 pb-16 pt-10 md:px-8 lg:grid-cols-[1.2fr_0.8fr] lg:items-center lg:py-16">
        ...
        <Card className="overflow-hidden border-slate-200 bg-white shadow-[0_30px_80px_rgba(13,46,102,0.16)]">
          <CardContent className="space-y-5 p-5 md:p-6">
            <div className="rounded-[2rem] bg-[linear-gradient(180deg,#0d2e66_0%,#132e55_100%)] p-6 text-white">
              <div className="flex items-center justify-between gap-4">
                <div className="text-xs uppercase tracking-[0.35em] text-blue-300">TopFit Running</div>
              ...
              <div className="mt-6 grid gap-3 sm:grid-cols-3">
                {content.proof.stats.map((stat) => (
                  <div key={stat.label} className="rounded-2xl border border-white/10 bg-white/8 px-4 py-4">
      ...
      {isHome ? (
        <>
          ...
          <section className="mx-auto grid max-w-7xl gap-6 px-5 py-10 md:px-8 lg:grid-cols-[0.95fr_1.05fr]">
        ...
        <SubscriptionsPage locale={locale} content={content} highlight={highlight} />
      ) : isShop ? (
        <ShopPage locale={locale} content={content} highlight={highlight} />
      ) : (
        <section className="mx-auto max-w-7xl px-5 py-10 md:px-8">
          <Card className="border-slate-200 bg-white shadow-sm">
        ...
        <Card className="border-slate-200 bg-white shadow-sm">
          <CardContent className="space-y-4 p-6 md:p-8">
            ...
            <div className="rounded-3xl bg-slate-950 p-5 text-white">
              <div className="text-xs uppercase tracking-[0.35em] text-blue-300">USP</div>
              <div className="mt-3 text-xl font-black uppercase tracking-[0.04em]">
                Niet zomaar een trainingsschema, maar een compleet systeem inclusief coaching, kennis en begeleiding.
              </div>
            </div>
          </CardContent>
        </Card>
      ...
      <section className="mx-auto max-w-7xl px-5 py-10 md:px-8">
        <Card className="overflow-hidden border-blue-200 bg-[linear-gradient(180deg,#0d2e66_0%,#081a3a_100%)] text-white shadow-[0_30px_80px_rgba(8,26,58,0.28)]">
          <CardContent className="space-y-5 p-6 md:p-8">
            <div className="flex items-center gap-3 text-xs font-semibold uppercase tracking-[0.35em] text-blue-300">
              <Users className="h-4 w-4" />
              {content.cta.title}
            </div>
            <div className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
              <div className="space-y-4">
                <p className="max-w-3xl text-lg leading-8 text-slate-200">{content.cta.lead}</p>
                <div className="flex flex-wrap gap-3">
                  <Button variant="hero" asChild>
                    <Link to={`/${locale}/contact`}>{content.cta.button}</Link>
                  </Button>
              ...
              <div className="grid gap-3 sm:grid-cols-3 lg:grid-cols-1">
                {[
                  locale === "en" ? "Start with a plan" : locale === "he" ? "התחל עם תכנית" : "Start met een plan",
                  locale === "en" ? "Add coaching later" : locale === "he" ? "הוסף אימון בהמשך" : "Voeg coaching later toe",
                  locale === "en" ? "Buy products in the shop" : locale === "he" ? "קנה מוצרים בחנות" : "Koop producten in de shop",
                ].map((item) => (
      ...
      <section className="mx-auto max-w-7xl px-5 py-10 md:px-8">
        <Card className="border-slate-200 bg-white shadow-sm">
          <CardContent className="space-y-5 p-6 md:p-8">
            ...
            <h2 className="max-w-4xl text-3xl font-black uppercase tracking-[0.04em] md:text-5xl">{content.cta.title}</h2>
...
const ShopPage = ({
            ...
            <CardContent className="space-y-4 p-6">
              ...
              <div className="flex flex-wrap gap-2">
                <Button size="sm" variant="hero" asChild>
                  <Link to={`/${locale}/contact`}>Bestel / vraag</Link>
                </Button>
                <Button size="sm" variant="heroOutline" asChild>
                  <Link to={`/${locale}/abonnementen`}>Abonnementen</Link>
                </Button>
              </div>
            </CardContent>
          </Card>
  ...
  return (
    <>
      ...
      <section className="mx-auto max-w-7xl px-5 py-10 md:px-8">
        {sectionBlock("Digitale producten", digital)}
      </section>

      <section className="mx-auto max-w-7xl px-5 py-10 md:px-8">
        {sectionBlock("Services en tickets", services)}
      </section>

      <section className="mx-auto max-w-7xl px-5 py-10 md:px-8">
        {sectionBlock("Fysieke producten", physical)}
      </section>
