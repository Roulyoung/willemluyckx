...
const services = {
  nl: [
    { title: "Trainingsschema's", summary: "Persoonlijke schema's voor elk niveau en elk doel.", tag: "Core" },
    { title: "Looptechniek", summary: "Videoanalyse met duidelijke verbeterpunten en oefeningen.", tag: "Technique" },
    { title: "Online coaching", summary: "Zoomgesprekken over training, herstel, voeding en focus.", tag: "Premium" },
    { title: "Clinics & kampen", summary: "Groepsdagen, natuur, theorie en praktijk in een sterk programma.", tag: "Events" },
    { title: "Mukti Running", summary: "Lopen als vrijheid, energie en mentale ruimte.", tag: "Philosophy" },
  ],
  en: [
    { title: "Training plans", summary: "Personal plans for every level and every goal.", tag: "Core" },
    { title: "Running technique", summary: "Video analysis with clear improvement points and drills.", tag: "Technique" },
    { title: "Online coaching", summary: "Zoom calls on training, recovery, nutrition and focus.", tag: "Premium" },
    { title: "Clinics & camps", summary: "Group days, nature, theory and practice in one strong program.", tag: "Events" },
...
export const topFitContent: Record<Locale, LocaleContent> = {
  nl: {
    ...
    about: {
      ...
      paragraphs: [
        "Willem Luijckx heeft meer dan 40 jaar ervaring als hardlooptrainer en docent trainingsleer.",
        "Hij combineert moderne trainingsmethodes met persoonlijke coaching, techniek, herstel en mentale balans.",
      ],
    },
    cta: {
      title: "Klaar om gericht te starten?",
      lead: "Begin met een schema op maat, vraag een techniekanalyse aan of plan een persoonlijk gesprek.",
  ...
  en: {
    ...
    about: {
      ...
      paragraphs: [
        "Willem Luijckx brings more than 40 years of running coaching and teaching experience.",
        "He combines modern training methods with personal coaching, technique, recovery and mental balance.",
      ],
    },
    cta: {
      title: "Ready to start with focus?",
      lead: "Begin with a custom plan, request a technique analysis or schedule a personal call.",
